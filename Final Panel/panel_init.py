...
indicator_panel.add_element(HALE.Image(pos_x = 0, pos_y = 0, width=100, height=60, image=background_image))

background_label3 = tk.Label(indicator_panel, image=background_image)
