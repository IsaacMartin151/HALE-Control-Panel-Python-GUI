...
main_panel.add_element(HALE.PushButton(text="WATER SURPRESSION", text_color="black", bgcolor = "#DDDDDD", font_size= 12, pos_x = 430, pos_y = 20, size_x = 140, size_y = 50))
main_panel.add_element(HALE.PushButton(text="WATER SURPRESSION", text_color="black", bgcolor = "#DDDDDD", font_size= 12, pos_x = 430, pos_y = 20, size_x = 140, size_y = 50))
...
main_panel.add_element(HALE.Rectangle(color="#CCCCCC", z = HALE.Depths.BACKGROUND, pos_x = 270, pos_y = 180, size_x = 470, size_y = 640))
...
main_panel.add_element(HALE.ToggleButton(off_text="Cycle Fuel VentOFF", on_text = "Cycle Fuel Vent ON", on_bgcolor="#AAAAAA", off_bgcolor = "#CCCCCC", on_text_color="#0022FF", off_text_color = "#010101", font_size= 10, pos_x = 870, pos_y = 690, size_x = 90, size_y = 50))
