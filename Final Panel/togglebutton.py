...
class ToggleButton(element.Element):
    ...
    def __init__(self, *, on_toggleon=None, on_toggleoff=None, off_text="OFF", on_text="ON", font="Arial Bold", font_size=24, off_text_color="white", off_bgcolor="red", on_text_color="white", on_bgcolor="#00DD11", starting_state=enums.ToggleStates.OFF,  **kwargs):
