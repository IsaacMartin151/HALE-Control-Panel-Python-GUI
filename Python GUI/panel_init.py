...
indicator_panel.add_element(HALE.IndicatorLight(text="Command",             starting_color="#969696", font=("Arial", 8), get_data = gd.command_led, pos_x=788, pos_y=45, size_x = 55, size_y = 50, refresh_interval=1000))
indicator_panel.add_element(HALE.IndicatorLight(text="Ox",                  starting_color="#969696", font=("Arial", 8), get_data = gd.ox_led, pos_x=788, pos_y=95, size_x = 55, size_y = 50, refresh_interval=1000))
indicator_panel.add_element(HALE.IndicatorLight(text="Fuel",                starting_color="#969696", font=("Arial", 8), get_data = gd.fuel_led, pos_x=788, pos_y=145, size_x = 55, size_y = 50, refresh_interval=1000))

indicator_panel.add_element(HALE.IndicatorLight(text="WS",                  starting_color="#969696", font=("Arial", 8), get_data = gd.ws_led, pos_x=829, pos_y=45, size_x = 55, size_y = 50, refresh_interval=1000))
indicator_panel.add_element(HALE.IndicatorLight(text="Camera",              starting_color="#969696", font=("Arial", 8), get_data = gd.camera_led, pos_x=829, pos_y=95, size_x = 55, size_y = 50, refresh_interval=1000))
indicator_panel.add_element(HALE.IndicatorLight(text="Office",              starting_color="#969696", font=("Arial", 8), get_data = gd.office_led, pos_x=829, pos_y=145, size_x = 55, size_y = 50, refresh_interval=1000))
indicator_panel.add_element(HALE.IndicatorLight(text="Record",              starting_color="#969696", font=("Arial", 8), get_data = gd.record_led, pos_x=829, pos_y=195, size_x = 55, size_y = 50, refresh_interval=1000))
indicator_panel.add_element(HALE.IndicatorLight(text="Igniter GO",          starting_color="#969696", font=("Arial", 8), get_data = gd.igniter_go_led, pos_x=829, pos_y=245, size_x = 55, size_y = 50, refresh_interval=1000))

indicator_panel.add_element(HALE.IndicatorLight(text="Nanny",               starting_color="#969696", font=("Arial", 8), get_data = gd.nanny_led, pos_x=872, pos_y=45, size_x = 55, size_y = 50, refresh_interval=1000))
indicator_panel.add_element(HALE.IndicatorLight(text="Sequence Flow Meter", starting_color="#969696", font=("Arial", 8), get_data = gd.sequence_flow_meter_led, pos_x=872, pos_y=145, size_x = 55, size_y = 50, refresh_interval=1000))
indicator_panel.add_element(HALE.IndicatorLight(text="Cold Flow",           starting_color="#969696", font=("Arial", 8), get_data = gd.cold_flow_led, pos_x=872, pos_y=245, size_x = 55, size_y = 50, refresh_interval=1000))

indicator_panel.add_element(HALE.IndicatorLight(text="ABORT",               starting_color="#969696", font=("Arial", 8), get_data = gd.abort_led, pos_x=939, pos_y=45, size_x = 55, size_y = 50, refresh_interval=1000))
indicator_panel.add_element(HALE.IndicatorLight(text="Igniter Armed",       starting_color="#969696", font=("Arial", 8), get_data = gd.igniter_armed_led, pos_x=939, pos_y=145, size_x = 55, size_y = 50, refresh_interval=1000))
indicator_panel.add_element(HALE.IndicatorLight(text="Startup",             starting_color="#969696", font=("Arial", 8), get_data = gd.startup_led, pos_x=939, pos_y=245, size_x = 55, size_y = 50, refresh_interval=1000))

#p&id
indicator_panel.add_element(HALE.IndicatorLight(text="ABV-WS-610", starting_color="#ff0000", get_data=gd.ABV_WS_610_led, pos_x=65, pos_y=86, size_x = 87, size_y = 57, refresh_interval=3000))

indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#00da6d", get_data=gd.ABV_OX_210_led, pos_x=325, pos_y=148, size_x = 15, size_y = 23, refresh_interval=3000))
indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#00da6d", get_data=gd.ABV_OX_220_led, pos_x=623, pos_y=436, size_x = 15, size_y = 23, refresh_interval=3000))
indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#00da6d", get_data=gd.ABV_OX_230_led, pos_x=695, pos_y=375, size_x = 15, size_y = 23, refresh_interval=3000))
indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#00da6d", get_data=gd.ABV_OX_240_led, pos_x=777, pos_y=578, size_x = 15, size_y = 23, refresh_interval=3000))
indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#00da6d", get_data=gd.ABV_OX_250_led, pos_x=487, pos_y=501, size_x = 15, size_y = 23, refresh_interval=3000))
                                                                                                            
indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#00da6d", get_data=gd.ABV_FU_310_led, pos_x=317, pos_y=858, size_x = 14, size_y = 23, refresh_interval=3000))
indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#ff0000", get_data=gd.ABV_FU_320_led, pos_x=619, pos_y=773, size_x = 14, size_y = 23, refresh_interval=3000))
indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#ff0000", get_data=gd.ABV_FU_330_led, pos_x=786, pos_y=836, size_x = 14, size_y = 23, refresh_interval=3000))
indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#ff0000", get_data=gd.ABV_FU_340_led, pos_x=777, pos_y=719, size_x = 14, size_y = 23, refresh_interval=3000))
indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#00da6d", get_data=gd.MBV_FU_350_led, pos_x=451, pos_y=846, size_x = 14, size_y = 23, refresh_interval=3000))
                                                                                                               
indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#00da6d", get_data=gd.ABV_PR_110_led, pos_x=140, pos_y=342, size_x = 14, size_y = 24, refresh_interval=3000))
indicator_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#ff0000", get_data=gd.ABV_PR_120_led, pos_x=139, pos_y=674, size_x = 14, size_y = 24, refresh_interval=3000))
   
indicator_panel.add_element(HALE.NumericDisplay(text="PT-OX-210", font=("Arial", 9), get_data=gd.PT_OX_210_numdisplay, pos_x=350, pos_y=340, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="PT-OX-211", font=("Arial", 9), get_data=gd.PT_OX_211_numdisplay, pos_x=270, pos_y=225, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="PT-OX-220", font=("Arial", 9), get_data=gd.PT_OX_220_numdisplay, pos_x=730, pos_y=470, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="PT-OX-230", font=("Arial", 9), get_data=gd.PT_OX_230_numdisplay, pos_x=675, pos_y=600, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="PT-OX-240", font=("Arial", 9), get_data=gd.PT_OX_240_numdisplay, pos_x=535, pos_y=550, size_x = 35, size_y = 45, refresh_interval=500)) 

indicator_panel.add_element(HALE.NumericDisplay(text="PT-FU-310", font=("Arial", 9), get_data=gd.PT_FU_310_numdisplay, pos_x=350, pos_y=650, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="PT-FU-311", font=("Arial", 9), get_data=gd.PT_FU_311_numdisplay, pos_x=275, pos_y=790, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="PT-FU-320", font=("Arial", 9), get_data=gd.PT_FU_320_numdisplay, pos_x=730, pos_y=790, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="PT-FU-330", font=("Arial", 9), get_data=gd.PT_FU_330_numdisplay, pos_x=675, pos_y=650, size_x = 35, size_y = 45, refresh_interval=500)) 

indicator_panel.add_element(HALE.NumericDisplay(text="PT-PR-110", font=("Arial", 9), get_data=gd.PT_PR_110_numdisplay, pos_x=30, pos_y=440, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="PT-PR-120", font=("Arial", 9), get_data=gd.PT_PR_120_numdisplay, pos_x=175, pos_y=575, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="PT-PR-130", font=("Arial", 9), get_data=gd.PT_PR_130_numdisplay, pos_x=175, pos_y=435, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="PT-PR-140", font=("Arial", 9), get_data=gd.PT_PR_140_numdisplay, pos_x=80, pos_y=160, size_x = 35, size_y = 45, refresh_interval=500)) 

indicator_panel.add_element(HALE.NumericDisplay(text="TC-OX-210", font=("Arial", 9), get_data=gd.TC_OX_210_numdisplay, pos_x=215, pos_y=140, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="TC-OX-220", font=("Arial", 9), get_data=gd.TC_OX_220_numdisplay, pos_x=430, pos_y=260, size_x = 35, size_y = 45, refresh_interval=500))
indicator_panel.add_element(HALE.NumericDisplay(text="TC-OX-221", font=("Arial", 9), get_data=gd.TC_OX_221_numdisplay, pos_x=430, pos_y=310, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="TC-OX-222", font=("Arial", 9), get_data=gd.TC_OX_222_numdisplay, pos_x=430, pos_y=360, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="TC-OX-223", font=("Arial", 9), get_data=gd.TC_OX_223_numdisplay, pos_x=430, pos_y=410, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="TC-OX-230", font=("Arial", 9), get_data=gd.TC_OX_230_numdisplay, pos_x=580, pos_y=430, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="TC-OX-240", font=("Arial", 9), get_data=gd.TC_OX_240_numdisplay, pos_x=650, pos_y=365, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="TC-OX-250", font=("Arial", 9), get_data=gd.TC_OX_250_numdisplay, pos_x=730, pos_y=295, size_x = 35, size_y = 45, refresh_interval=500)) 

indicator_panel.add_element(HALE.NumericDisplay(text="TC-FU-310", font=("Arial", 9), get_data=gd.TC_FU_310_numdisplay, pos_x=215, pos_y=730, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="TC-FU-320", font=("Arial", 9), get_data=gd.TC_FU_320_numdisplay, pos_x=430, pos_y=735, size_x = 35, size_y = 45, refresh_interval=500)) 
indicator_panel.add_element(HALE.NumericDisplay(text="TC-FU-330", font=("Arial", 9), get_data=gd.TC_FU_330_numdisplay, pos_x=580, pos_y=770, size_x = 35, size_y = 45, refresh_interval=500)) 

indicator_panel.add_element(HALE.NumericDisplay(text="TC-PR-110", font=("Arial", 9), get_data=gd.TC_PR_110_numdisplay, pos_x=75, pos_y=480, size_x = 35, size_y = 45, refresh_interval=500)) 


indicator_panel.add_element(HALE.BarChart(get_data=gd.ox_barchart, bgcolor = "#FFFFFF", barcolor = "#00FF00", pos_x=399, pos_y=281, size_x = 14, size_y = 127, refresh_interval=50)) 
indicator_panel.add_element(HALE.BarChart(get_data=gd.fuel_barchart, bgcolor = "#FFFFFF", barcolor = "#FF0000", pos_x=398, pos_y=621, size_x = 15, size_y = 128, refresh_interval=1000)) 
...
engine_panel.add_element(HALE.Chart(pos_x = 0, pos_y = 0, size_x = 300, size_y = 400, title="Tank Temps", xlabel="Time", ylabel="Amplitude", lines = [("TC-OX-220", "#FFFFFF"), ("TC-OX-221", "#FF00FF"), ("TC-OX-222", "#0000FF"), ("TC-OX-223", "#FF0000"), ("TC-FU-320", "#00FF00"), ("TC-CC-410", "#FFFF00"), ("TC-CC-411", "#00FFFF"), ("TC-CC-412", "#123456")], get_data = gd.tank_temps_chart, refresh_interval = 4000))
engine_panel.add_element(HALE.Chart(pos_x = 650, pos_y = 0, size_x = 300, size_y = 400, title="Chamber Pressures", xlabel="Time", ylabel="Amplitude", lines = [("PT-CC-410", "#FFFFFF"), ("PT-CC-420", "#FF00FF")], get_data = gd.chamber_pressures_chart, refresh_interval = 5000))
engine_panel.add_element(HALE.Chart(pos_x = 120, pos_y = 600, size_x = 700, size_y = 350, title="Pressures(psi) - Thrust (lbf)", xlabel="Time", ylabel="Thrust - Pressure", lines = [("Thrust", "#000000")], get_data = gd.thrust_chart, refresh_interval = 2000))

engine_panel.add_element(HALE.IndicatorLight(text="Ox Main Valve",   starting_color="#0e6e07", get_data = gd.ox_main_valve_led, pos_x = 20, pos_y = 640, size_x = 100, size_y = 50, refresh_interval = 50))
engine_panel.add_element(HALE.IndicatorLight(text="Fuel Main Valve", starting_color="#0e6e07", get_data = gd.fuel_main_valve_led, pos_x = 20, pos_y = 740, size_x = 100, size_y = 50, refresh_interval = 50))
...
main_panel.add_element(HALE.IndicatorLight(text="ABV-WS-610 LED", starting_color="#0e6e07", get_data =  gd.ABV_WS_610_led, pos_x = 600, pos_y = 30, size_x = 150, size_y = 50, refresh_interval = 50))


#right side, from top to bottom
main_panel.add_element(HALE.IndicatorLight(text="Igniter",        starting_color="#FF0000", get_data = gd.igniter_led, pos_x = 815, pos_y = 30, size_x = 150, size_y = 50, refresh_interval = 500))
main_panel.add_element(HALE.IndicatorLight(text="ABV-WS-620 LED", starting_color="#0e6e07", get_data = gd.ABV_WS_620_led, pos_x = 790, pos_y = 110, size_x = 150, size_y = 50, refresh_interval = 1000))
...
main_panel.add_element(HALE.IndicatorLight(text="Flow Meter Installed",  starting_color="#0e6e07", get_data = gd.flow_meter_installed_led, pos_x = 750, pos_y = 340, size_x = 150, size_y = 50, refresh_interval = 250))
main_panel.add_element(HALE.IndicatorLight(text="Cryo Cold Flow Active", starting_color="#0e6e07", get_data = gd.cryo_cold_flow_active_led, pos_x = 870, pos_y = 340, size_x = 150, size_y = 50, refresh_interval = 50))
...
main_panel.add_element(HALE.IndicatorLight(text=None, starting_color="#0e6e07", get_data = gd.cryo_fill_led, pos_x = 114, pos_y = 214, size_x = 22, size_y = 38, refresh_interval = 500))
