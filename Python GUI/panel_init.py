...
#bottom
main_panel.add_element(HALE.PushButton(text="ABORT", onclick = oc.abort, text_color="white", bgcolor = "#5dc926", font_size= 48, pos_x = 315, pos_y = 840, size_x = 380, size_y = 150))
